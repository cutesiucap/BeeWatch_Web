...
namespace API.Controllers
{
    public class Address_DistrictController : ApiController
    {
        ...
        public IQueryable<Address_District> GetAddress_District()
        {
            return db.Address_District;
        }

        [HttpGet]
        [Route("api/Address_District/District_by_id_Province/{idprovince}")]
        public IQueryable<Address_District> District_by_id_Province(string idprovince)
        {
            return db.Address_District.Where(x=>x.id_Province==idprovince);
        }
